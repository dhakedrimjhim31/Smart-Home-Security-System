...
while True:
    ...
    for encodeFace, faceLocation in zip(encodeCF, faceCF):
        ...
        if match[matchIndex]:
            ...
            # Verifying against authorized users
            id = ids[matchIndex]
            if id in ids:  # Add a list of authorized user IDs
                ...
                # Stranger detected, reject access and sound alarm
                print("Stranger detected! Access Denied.")
                winsound.Beep(1000, 2000)  # Beep sound (1000 Hz, 2 seconds)
